      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-8 sm:p-10 lg:p-12 border border-gray-100 dark:border-slate-700">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-3">Create Account</h1>
            <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg">Join us and start shopping</p>
          </div>
          ...
          <div className="mt-10 border-t-2 border-gray-200 dark:border-slate-700 pt-8">
            <p className="text-center text-gray-600 dark:text-gray-400 text-base">
              ...
              <Link href="/auth/login" className="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition">
                Sign in
              </Link>
            </p>
          </div>
